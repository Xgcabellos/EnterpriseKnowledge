...
class JsonStorageEmail():
    ...
    def active_log(self, log_name='JsonStorageEmail.log', level=INFO, log_directory='./logs/'):
        ...
        self.logger.debug('Starting jsonStorageEmail logger using v.' + str(
