...
class ConnexionProperties(object):
...
class google_connexionProperties(ConnexionProperties):
    """abstact class for email server connecxion .
    ...
    def __init__(self, org_email, from_email, from_password, smtp_server="imap.Gmail.com", smtp_port=993,
                 crypted=True):  # ,smtp_server,smtp_port):
        """Return a new connecxion_properties object
          """
        self.ORG_EMAIL = org_email
        self.FROM_EMAIL = from_email + self.ORG_EMAIL
...
class email_IMAP_connexionProperties(ConnexionProperties):
    """abstact class for email server connecxion .
...
class email_POP3_connexionProperties(ConnexionProperties):
    """abstact class for email server connecxion .
    ...
    def __init__(self, org_email, from_email, from_password, smtp_server=None, smtp_port=0,
                 crypted=True) -> object:  # ,smtp_server,smtp_port):
        """Return a new connecxion_properties object
              """
        self.ORG_EMAIL = org_email
        self.FROM_EMAIL = from_email + self.ORG_EMAIL
...
class email_DUMMY_connexionProperties(ConnexionProperties):
    """abstact class for email server connecxion .
